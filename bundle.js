...
const userInput = document.getElementById('chat_input');
...
userInput.addEventListener('onchange', (e) => {
    console.log('input: ', userInput.value);
});

sendButton.addEventListener('onclick', (e) => {
    e.preventDefault();
...
const displayMessage = (message) => {
    ...
    meMessageContainer.className = 'me_message_container';

    const meMessageText = document.createElement('div');
    meMessageText.classList = 'me_message_container';
    meMessageText.textContent = message;
